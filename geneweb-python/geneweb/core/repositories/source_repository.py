...
class SourceRepository:
    ...
    def add_source(self, title: str, reference: str, type: str, repository: str = None, notes: str = None):
        source = Source(
            title=title,
            reference=reference,
            type=type,
    ...
    def update_source_by_id(self, source_id: int, title: str = None, reference: str = None, type: str = None, repository: str = None, notes: str = None):
